...
public class Deck {
	...
	/**
	 * Create a <code>Deck</code> of 52 <code>Card</code> objects. Shuffle these objects.
	 */
	public Deck() {
	 ...
	 * 
	 * @return true if the <code>Deck</code> contains no <code>Card</code> objects; otherwise, false
	 */
